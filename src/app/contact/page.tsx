...
export default function ContactPage() {
  const whatsappUrl = "https://wa.me/923111879802?text=Hello,%20I%20would%20like%20to%20get%20in%20touch%20regarding%20sportswear%20manufacturing.";
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-3xl sm:text-5xl font-black uppercase tracking-tight mb-6">
            Contact Next Vision Sports
          </h1>
          <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
            We operate as a direct B2B manufacturer and showcase catalog. Contact us instantly through any of the channels below for inquiries, custom orders, and catalogs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <div className="bg-[#12141C] border border-gray-800 p-8 rounded-3xl flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-400 text-sm mb-6">
                Send us your detailed inquiries or visit our Instagram page.
              </p>
              <div className="space-y-4 mb-8 text-sm">
                ...
                <div className="flex items-center gap-3 text-gray-300">
                  ...
                  <a href="https://www.instagram.com/nexvion_sports?stkn=YmQyNHFkcXh5MG5m" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
