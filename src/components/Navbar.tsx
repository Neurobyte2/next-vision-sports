  ...
  return (
    <header className="sticky top-0 z-50 bg-[#090A0F]/95 backdrop-blur-md border-b border-gray-800 text-white">
      ...
      <div className="bg-emerald-600 text-xs py-1.5 px-4 text-center font-medium flex justify-center items-center gap-6">
        ...
        <a href="mailto:abdullahjarral194@gmail.com" className="hover:underline hidden md:inline">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="p-2.5 bg-gray-900 border border-gray-800 hover:border-emerald-500 rounded-full text-gray-300 hover:text-white transition-colors flex items-center justify-center"
          >
